...
for(let i=0;i<tai;i++){
    if(tab[i]===elemont){
        console.log("aloure le nombre qui rocherch il y a dans le tableau à l'indice : "+i );
        cont++;
         break;
    }
}
if(cont===0){
    console.log("aloure le nombre qui rocherch il ya pas  dans le tableau à l'indice : ");
}